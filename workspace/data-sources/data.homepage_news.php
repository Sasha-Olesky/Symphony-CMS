...
class datasourcehomepage_news extends SectionDatasource
{
    public $dsParamROOTELEMENT = 'homepage-news';
    ...
    public $dsParamINCLUDEDELEMENTS = array(
        'title-en: unformatted',
        'title-cy: unformatted',
        'abstract-en: formatted',
        'abstract-cy: formatted',
        'accent',
        'date',
        'featured-image',
        'crop'
    ...
    public function about()
    {
        return array(
            ...
            'release-date' => '2018-06-06T15:39:02+00:00'
        );
    }
