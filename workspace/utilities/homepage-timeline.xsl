						...
						<div class="viewport">
							<div class="images">
								<div class="points">
									...
									<div class="point not-desktop">
										<img class="background" src="{$workspace}/assets/images/timeline/17.png" alt="" />
									</div>
									<div class="point not-mobile">
										<img class="background" src="{$workspace}/assets/images/timeline/18.png" alt="" />
										<div class="inner timeline-video">

											<iframe src="https://player.vimeo.com/video/293897352" width="533" height="300" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
										</div>
									</div>
								</div>
							</div>
